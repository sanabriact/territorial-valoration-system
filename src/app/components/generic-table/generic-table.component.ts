...
export class GenericTableComponent {
  ...
  /** Devuelve true si el grupo es de tipo select */
  isSelectFilter(group: FilterGroup): group is SelectFilterGroup {
    return group.type === 'select';
  }

  /** Devuelve true si el grupo es de tipo chip (por defecto) */
  isChipFilter(group: FilterGroup): group is ChipFilterGroup {
    return !group.type || group.type === 'chip';
  }
  ...
  /** Maneja el cambio en un filtro tipo select */
